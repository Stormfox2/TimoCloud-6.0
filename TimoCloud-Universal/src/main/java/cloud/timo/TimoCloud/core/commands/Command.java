...
public abstract class Command {
    ...
    public void prepareCommand(Builtins.CommandInput input) {
        if (!onCommand(input)) printUsage();
    }

    public abstract boolean onCommand(Builtins.CommandInput input);

    public abstract List<Completer> complete(String command);
    ...
    public void printUsage() {
        TimoCloudCore.getInstance().getLogger().warning("Please use: " + usage);
    }
